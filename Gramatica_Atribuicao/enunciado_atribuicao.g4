...
//Talvez também seja interessante separar operador em tres tipos, aritmeticos 
operador: '+' | '-' | '*' | '/' | '<' | '>' | '<=' | '>=';
...
expressao: (LITERAL_NUMERICO | ((LITERAL_NUMERICO | IDENTIFICADOR) operador (LITERAL_NUMERICO| IDENTIFICADOR)))) | expressao;

//Abaixo a expressão numérica
//expressao_aritmetica: LITERAL_NUMERICO | IDENTIFICADOR | ((LITERAL_NUMERICO | IDENTIFICADOR) (operador_aritmetico (LITERAL_NUMERICO | IDENTIFICADOR))*);
//Abaixo a expressão relacional
//expressao_relacional: LITERAL_NUMERICO operador_relacional LITERAL_NUMERICO;
